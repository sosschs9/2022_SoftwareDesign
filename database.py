...
def getPost(postIdx:int):
    ...
    post =  Post(result['_Post__writerID'], result['_Post__date'], result['_Post__contents'], result['_Post__postIdx'], result['_Post__title'], addr, result['_Post__pay'])

    for i in result['commentList']:
        post.createComment(i['_Comment__writerID'], i['_Comment__date'], i['_Comment__contents'], i['_Comment__commentIdx'])
...
def getMatching(matchingIdx:int):
    ...
    if result != None:
        return Accompany(result['_Accompany__date'], result['_Accompany__address'], result['_Accompany__reason'], result['_Accompany__hospitalLocation'])
    ...
    if result != None:
        return SafetyCheck(result['_SafetyCheck__date'], result['_SafetyCheck__address'], result['_SafetyCheck__checkpart'])
    return None
